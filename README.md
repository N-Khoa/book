...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 861c3992-aaf1-4f1a-85ef-9cc6a7930116
```

> `861c3992-aaf1-4f1a-85ef-9cc6a7930116` is the password of the certificate, you can change it to any password you want.
